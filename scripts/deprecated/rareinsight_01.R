          ...
          fluidRow(
                ...
                column(width = 12,
                       div(style = "text-align: center;",
                           tags$img(src = "pic.jpg",
                                    width = "20%", height = 150)  # Adjust width and height as needed
                       )
                ),
                fluidRow(
                  column(width = 12,
          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              div(
                ...
                h4(div(style = "text-align: center;",img(src = "https://www.genomicseducation.hee.nhs.uk/wp-content/uploads/2019/06/Half-plus-half-equals-you-960x640.png", height = 350, width = 350)))
              ),
              div(
                ...
                div(
                  ...
                  img(src = "https://rareshareprod.s3.amazonaws.com/uploads/ckeditor/pictures/51/content_Chromosomes.png", height = 350, width = 350),
                  img(src = "https://www.genomicseducation.hee.nhs.uk/wp-content/uploads/2018/08/DNA-double-helix_13081113544_l.jpg", height = 350, width = 350)
                )
              ),
              ...
              div(
                ...
                h4(div(style = "text-align: center;",img(src = "https://cdn.bluebirdbio.com/-/media/Gene_Therapy/com/1/understanding-genetic-diseases/gene-inheritance-example.png?mw=522&rev=ac214731a4824980a5f5a0cf8df4b8a0&hash=DAE97500D51B477B45304E0B24BD7357", height = 350, width = 350)))
              )
            ),
            tabPanel(
              "Rare Diseases",
              ...
              div(
                ...
                h4(div(style = "text-align: center;",img(src = "https://rareshareprod.s3.amazonaws.com/uploads/ckeditor/pictures/50/content_DomRessive.png", height = 300, width = 300))),
